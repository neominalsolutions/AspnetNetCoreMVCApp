...
using AspnetNetCoreMVCApp.Entities.Configurations;
...
namespace AspnetNetCoreMVCApp.Entities
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<Fragmentationview> Fragmentationviews { get; set; } = null!;
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=(localDB)\\MyLocalDb;Database=Northwind;Trusted_Connection=True;");
            }
        }

       // model oluşma aşamasında veri tabanına nesne ile ilgili yansıtılacak işlemler.
       // migration sonrası db güncellenir.
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AlphabeticalListOfProduct>(entity =>
            {
                entity.HasNoKey(); // hasNoKey

                entity.ToView("Alphabetical list of products"); // sql deki view ismi
          ...
          modelBuilder.ApplyConfiguration(new CustomerConfiguration());
            ...
            modelBuilder.Entity<Fragmentationview>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("FRAGMENTATIONVIEW");

                entity.Property(e => e.Fragmentation).HasColumnName("fragmentation");

                entity.Property(e => e.Index).HasMaxLength(128);
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.HasIndex(e => e.ProductId, "ClusteredIndex-20230526-122741")
                    .IsClustered();

                entity.HasIndex(e => new { e.UnitPrice, e.UnitsInStock }, "NCLX_PriceAndStock")
                    .HasFilter("([UnitPrice]<(1000) AND [UnitsInStock]<(10))");

                entity.HasIndex(e => e.ProductName, "NonClusteredIndex-20230526-122307");
                ...
                entity.HasIndex(e => e.ProductName, "UX_ProductName")
                    .IsUnique();
